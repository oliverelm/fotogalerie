...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const isInlineFallback = Boolean(req.query.inline);
    res.setHeader("Content-Type", meta.mimeType || "application/octet-stream");
    const disposition = isInlineFallback ? "inline" : "attachment";
    res.setHeader(
      "Content-Disposition",
    ...
    // Nur echte Original-Downloads zählen, nicht die Vorschaubild-Rückfälle.
    if (!isInlineFallback) incrCounter("downloads");
